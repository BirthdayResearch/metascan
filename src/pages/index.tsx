...
export default function Home() {
  return (
    <NetworkProvider>
      ...
      <div className="w-full h-screen absolute top-[836px] sm:top-[210px] z-[-1] mix-blend-screen bg-no-repeat bg-contain bg-right sm:bg-[url('/background/gradient-blue-mobile.png')] bg-[url('/background/gradient-blue-mobile.png')]" />
    </NetworkProvider>
  );
}
